...
$lang = array_merge($lang, array(
	...
	'report_reasons'		=> array(
		'TITLE'	=> array(
			...
			'OTHER'		=> 'Друго',
			'DUPLICATE_POST'	=> 'Дублиране на мнение',
			'PERSONAL_INFORMATION'	=> 'Лични данни',
			'THREAT'	=> 'ЗАПЛАХИ',
			'RUDE_LANGUAGE'	=> 'Груб език',
			'CYRYLIC_REQUIRED'	=> 'Писане на кирилица',
		),
		'DESCRIPTION' => array(
			'WAREZ'		=> 'Мнение съдържа връзки към нелегален или пиратски софтуер.',
			'SPAM'		=> 'Мнение рекламира уебсайт или друг друг продукт.',
			'OFF_TOPIC'	=> 'Мнение няма връзка с темата.',
			'OTHER'		=> 'Мнение не попада в никоя от другите категории, моля използвайте полето за да опишете нарушението.',
			'DUPLICATE_POST' => 'Мнението се дублира с предходното.',
			'PERSONAL_INFORMATION'	=> 'Съдържание на лична информация, която е в разрез с правилата на сайта!',
			'THREAT'	=> 'Съдържание на ЗАПЛАХИ, намеци за заплахи, саморазправа и др. подобни.',
			'RUDE_LANGUAGE'	=> 'Съдържа груб език, обиди или неграмотно писане.',
			'CYRYLIC_REQUIRED'	=> 'Писането на кирилица е задължително в този форум.',
		),
	),
));
